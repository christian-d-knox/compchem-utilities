...
def genBench(fileList):
    for x in range(len(fileList)):
        ...
        for methodLine in methodFile:
            ...
            runJob(genFile(tempName, coordFullPath, methodLine, methodFirstSub, charge, multiplicity))
...
def genSinglePoint(fileList):
    for x in range(len(fileList)):
        ...
        runJob(genFile(baseName, coordFullPath, methodLine, methodFirstSub, charge, multiplicity))
